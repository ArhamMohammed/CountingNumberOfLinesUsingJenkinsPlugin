...
public class CountingLinesUtilClass {
    ...
    //            // The while loop reads data from the input stream into the buffer until the end of the stream is
    // reached
    ...
    //            // results in better performance, especially in situations where many string manipulations are
    // performed.
